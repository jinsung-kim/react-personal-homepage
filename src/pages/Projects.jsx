        ...
        <div className={`projects-container${ width < 500 ? "-small" : ""}`}>
            ...
            <div className={`main-content${ width < 500 ? "-small" : ""}`}>
                ...
                <ul>
                    ...
                    <li><a href="https://github.com/jinsung-kim/chess-engine" target="_blank" rel="noreferrer">Algorithmic Dressing</a> - generating combinations of clothes based on color blocking, silhouette, and weather with the aim to find new interesting looks.</li>
                </ul>
            </div>
        </div>
    );
